...
describe('generateApi with schema validation', () => {
  ...
  describe('Add schema validation policy', () => {
    it('Output validation protection policy should be generated', async () => {
      ...
      expect(result.Javascript.ResourceURL[0]).toBe('jsc://schema-validation.js')
      expect(result.Javascript.IncludeURL[0]).toBe('jsc://api.js')
      // expect(result.Javascript.IncludeURL[1]).toBe('jsc://regex-utils.js')
      expect(result.Javascript.IncludeURL[1]).toBe('jsc://bundle-policify.js')
    })
    ...
    it('Input validation protection policy should be generated', async () => {
      ...
      // Check Header name and value
      expect(result.Javascript.ResourceURL[0]).toBe('jsc://input-validation.js')
      expect(result.Javascript.IncludeURL[0]).toBe('jsc://api.js')
    })
    ...
    it('Raise fault policy should be generated', async () => {
      ...
      expect(result.RaiseFault.FaultResponse[0].Set[0].ReasonPhrase[0]).toBe('Server Error')
      expect(result.RaiseFault.FaultResponse[0].Set[0].StatusCode[0]).toBe('500')
    })
    ...
    it('Proxy should contain Add Validation step in PostFlow', async () => {
      ...
      expect(result.ProxyEndpoint.PostFlow[0].Response[0].Step[0].Name[0]).toBe('Add Output Validation')
    })
    ...
    it('Proxy should contain Raise Validation Error step in PostFlow', async () => {
      ...
      expect(result.ProxyEndpoint.PostFlow[0].Response[0].Step[1].Name[0]).toBe('Raise Output Validation Error')
    })
    ...
    it('Proxy should contain Extract Path Parameters step in PreFlow', async () => {
      ...
      expect(result.ProxyEndpoint.PreFlow[0].Request[0].Step[0].Name[0]).toBe('Extract Path Parameters')
    })
    ...
    it('Proxy should contain Add Validation step in PreFlow', async () => {
      ...
      expect(result.ProxyEndpoint.PreFlow[0].Request[0].Step[1].Name[0]).toBe('Add Input Validation')
    })
    ...
    it('Proxy should contain Raise Input Validation Error step in PreFlow', async () => {
      ...
      expect(result.ProxyEndpoint.PreFlow[0].Request[0].Step[2].Name[0]).toBe('Raise Input Validation Error')
    })
  })
})
