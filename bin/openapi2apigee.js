...
program
  ...
  .action((apiProxy, options) => {
    executed = true
    generateApi(apiProxy, options).then(() => {
...
program.on('--help', ()=> {
  ...
  console.log('    $ openapi2apigee generateApi petstore-v2 -s $SRC -d ./examples_proxies')
  console.log('    $ openapi2apigee generateApi petstore-v2 -s $SRC -d ./examples_proxies -n -b $URI -o $ORG -e $ENV -v secure -D ')
  console.log('')
  ...
  console.log('    $ openapi2apigee generateApi petstore-v3 -s $SRC -d ./examples_proxies')
  console.log('    $ openapi2apigee generateApi petstore-v3 -s $SRC -d ./examples_proxies -n -b $URI -o $ORG -e $ENV -v secure -D')
  console.log('')
});
